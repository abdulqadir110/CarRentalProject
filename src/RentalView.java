...
///////////////////////////////////////////////receipt/////////////////////////////////////
	...
	//-------------------------------------------------setting PANEL and LABELS for Welcome section
	    ...
	    ImageIcon titleImage = new ImageIcon("C:/Users/abdul/OneDrive/Desktop/Java project/Basic-Java-Car-Rental-System-master/Basic-Java-Car-Rental-System-master/Romy Car Rental/images/logo1.GIF");
	...
	//--------------------------------------COMBO BOX for current date
		...
		Integer[] currentYearCB = {2020, 2021, 2022, 2023, 2024, 2025, 2026, 2027};
		cYCB = new JComboBox(currentYearCB);
		cYCB.setBounds(490, 240, 60, 25);
		mainP.add(cYCB);
	
	//------------------------------------BUTTONS to go reserve section
		ImageIcon mainNextImage = new ImageIcon("C:/Users/abdul/OneDrive/Desktop/Java project/Basic-Java-Car-Rental-System-master/Basic-Java-Car-Rental-System-master/Romy Car Rental/images/next.GIF");
	...
	//-----------------------------------------------to go customer section
		ImageIcon dateNextImage = new ImageIcon("C:/Users/abdul/OneDrive/Desktop/Java project/Basic-Java-Car-Rental-System-master/Basic-Java-Car-Rental-System-master/Romy Car Rental/images/customer.GIF");
	...
	//---------------------------------------------------to go back welcome section
		...
		ImageIcon dateBackImage = new ImageIcon("C:/Users/abdul/OneDrive/Desktop/Java project/Basic-Java-Car-Rental-System-master/Basic-Java-Car-Rental-System-master/Romy Car Rental/images/back.GIF");
	...
	//----------------------------------------------to go pick a car section
		ImageIcon customerNextImage = new ImageIcon("C:/Users/abdul/OneDrive/Desktop/Java project/Basic-Java-Car-Rental-System-master/Basic-Java-Car-Rental-System-master/Romy Car Rental/images/car.GIF");
	...
	//--------------------------------------------to go back reserve section
		...
		ImageIcon customerBackImage = new ImageIcon("C:/Users/abdul/OneDrive/Desktop/Java project/Basic-Java-Car-Rental-System-master/Basic-Java-Car-Rental-System-master/Romy Car Rental/images/customer_back.GIF");
	...
	//---------------------------------------------------------Pick Car Buttton]
	//-------------------------------------first car button
		ImageIcon firstCarImage = new ImageIcon("C:/Users/abdul/OneDrive/Desktop/Java project/Basic-Java-Car-Rental-System-master/Basic-Java-Car-Rental-System-master/Romy Car Rental/images/van.GIF");
	...
	//---------------------------------second car button
		ImageIcon secondCarImage = new ImageIcon("C:/Users/abdul/OneDrive/Desktop/Java project/Basic-Java-Car-Rental-System-master/Basic-Java-Car-Rental-System-master/Romy Car Rental/images/pickup.GIF");
	...
	//---------------------------------------third car button
		ImageIcon thirdCarImage = new ImageIcon("C:/Users/abdul/OneDrive/Desktop/Java project/Basic-Java-Car-Rental-System-master/Basic-Java-Car-Rental-System-master/Romy Car Rental/images/jeepney.GIF");
	...
	//------------------------------------------forth car button
		ImageIcon forthCarImage = new ImageIcon("C:/Users/abdul/OneDrive/Desktop/Java project/Basic-Java-Car-Rental-System-master/Basic-Java-Car-Rental-System-master/Romy Car Rental/images/limousine.GIF");
	...
	//-------------------------------------------------to go receipt section (Final step)
		ImageIcon carNextImage = new ImageIcon("C:/Users/abdul/OneDrive/Desktop/Java project/Basic-Java-Car-Rental-System-master/Basic-Java-Car-Rental-System-master/Romy Car Rental/images/submit.GIF");
	...
	//--------------------------------------------------------------------to go back customer section
		ImageIcon carBackImage = new ImageIcon("C:/Users/Abdul Qadir Lonara/Desktop/Java project/Basic-Java-Car-Rental-System-master/Basic-Java-Car-Rental-System-master/Romy Car Rental/images/car_back.GIF");
			...
			if(event.getActionCommand().equals("NextToCustomer")) {
				...
				if(aTrans.toStringDateChecker().equals("TRUE") && aTrans.toStringAgeChecker().equals("TRUE")) { //checker to proceed next panel
					...
					if(openWarningReserve == null){
						...
						ImageIcon warningReserveImage = new ImageIcon("C:/Users/abdul/OneDrive/Desktop/Java project/Basic-Java-Car-Rental-System-master/Basic-Java-Car-Rental-System-master/Romy Car Rental/images/warning_top_icon.GIF");
			...
			if(event.getActionCommand().equals("NextToPickCar")) {
				...
				if(!aCustomer.getFirstName().equals("Type First Name Here") && !aCustomer.getLastName().equals("Type Last Name Here") && !aCustomer.getGender().equals("M/F") && !aCustomer.getStatus().equals("S/Ma") && !aCustomer.getLocation().equals("Type Complete Address Here") && !aCustomer.getContact().equals("Type Contact Number Here")){
					...
					if(openWarningCustomer == null){
						...
						ImageIcon warningCustomerImage = new ImageIcon("C:/Users/abdul/OneDrive/Desktop/Java project/Basic-Java-Car-Rental-System-master/Basic-Java-Car-Rental-System-master/Romy Car Rental/images/warning_top_icon.GIF");
		...
		public void actionPerformed(ActionEvent event) {
			...
			if(event.getActionCommand().equals("Car1")) { //passing the pick-up details to car details class and final transactions.
				...
				if(openWarningCar == null){
					...
					ImageIcon warningCarImage = new ImageIcon("C:/Users/abdul/OneDrive/Desktop/Java project/Basic-Java-Car-Rental-System-master/Basic-Java-Car-Rental-System-master/Romy Car Rental/images/warning_top_icon.GIF");
